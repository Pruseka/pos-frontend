...
import { GetAllCustomersData as GetAllSuppliersData } from '../../../../api/customer/queries/getAllCustomers'
import { toSentenceCase } from '../../../../helpers/conver-title'
import FormModal from './form-modal'
import useStyles from './styles'
import { CSVLink } from 'react-csv'

export type Item = Partial<GetAllSuppliersData[0]>
...
const PosTable: React.FC<TableProps> = ({
   ...
   const searchedData = data.filter((supplier) => supplier.name?.toLowerCase().includes(query))
